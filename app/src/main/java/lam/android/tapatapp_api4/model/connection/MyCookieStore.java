 ...
 * A shared preferences cookie store.
 */
public final class MyCookieStore implements CookieStore {
    ...
    public synchronized void add(URI uri, HttpCookie cookie) {
        ...
        prefsWriter.putString(COOKIE_NAME_PREFIX + uri,
                encodeCookie(new MyCookie(cookie)));
        prefsWriter.commit();
    }
     ...
     */
    protected String encodeCookie(MyCookie cookie) {
        if (cookie == null)
            return null;
        ...
        try {
            ...
            Log.d("LOGTAG", "IOException in encodeCookie", e);
            return null;
        }
    ...
    protected HttpCookie decodeCookie(String cookieString) {
        ...
        try {
            ...
            cookie = ((MyCookie) objectInputStream.readObject())
                    .getCookie();
        } catch (IOException e) {
            Log.d("LOG_TAG", "IOException in decodeCookie", e);
        } catch (ClassNotFoundException e) {
            Log.d("LOGTAG", "ClassNotFoundException in decodeCookie", e);
        }
